...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'hello-func-cpp.wast';
  var wasmBinaryFile = 'hello-func-cpp.wasm';
  var asmjsCodeFile = 'hello-func-cpp.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_hello_func_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 291;

Module['wasmMaxTableSize'] = 291;
...
var real___GLOBAL__sub_I_hello_func_cpp = asm["__GLOBAL__sub_I_hello_func_cpp"]; asm["__GLOBAL__sub_I_hello_func_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_hello_func_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_hello_func_cpp = Module["__GLOBAL__sub_I_hello_func_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_hello_func_cpp"].apply(null, arguments) };
